<!-- Generado por scripts/indexar.mjs. No editar a mano: los cambios se pierden. -->
# Índice global del repositorio

Inventario completo de los 104 documentos del repositorio, con su tipo, su estabilidad y los temas que cubre cada uno. Sirve para decidir qué módulo cargar sin abrirlos todos. El enrutamiento con criterio está en [SKILL.md](SKILL.md).

**Generado:** 2026-07-30 · **Regenerar:** `node scripts/indexar.mjs`

## Resumen

| Dominio | Documentos | Enrutador |
|---|---|---|
| Raíz | 1 | [SKILL.md](SKILL.md) |
...
|---|---|---|---|---|
| [SKILL.md](SKILL.md) | Skill de Índice — enrutador maestro del repositorio | enrutador | — | 1. Protocolo de enrutamiento · 2. Mapa de dominios · 3. Preguntas que cruzan dominios · 4. Estabilidad: lo que caduca y lo que no · 5. Mantener el ín… |
